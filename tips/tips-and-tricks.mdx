...
{/* TODO: Graphic — scattered "tip cards" or sticky notes with icons, giving a playful "cheat sheet" vibe */}
...
{/* TODO: Screenshot — a draft email card in Runner with Edit / Send / Discard buttons */}
...
{/* TODO: Screenshot — the dictation input bar in Runner */}

---

## Search across everything

Press `Cmd+F` (Mac) or `Ctrl+F` (Windows/Linux) to search across every conversation in your workspace. Messages, results, file content. All of it.
...
{/* TODO: Graphic — a daily timeline showing morning, midday, and evening with example prompts mapped to each part of the day */}
