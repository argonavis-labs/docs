...
description: "Share Runner with people you work with and help them get set up instantly."
---

Know someone who could use Runner? Share your personal invite link or referral code and they'll be connected to you as soon as they sign up.

{/* TODO: Graphic — two people icons with an arrow between them, one handing a "link" to the other. Warm, friendly, not corporate. */}

## Two ways to invite someone

### Share your invite link

The fastest way. Click **Share** in your sidebar and copy your personal invite link. Send it however you want. Text, email, Slack.

When they click your link and sign up, they're connected to you right away.

{/* TODO: Screenshot — the sidebar Share option with the copy-link button */}
...
<Steps>
  <Step title="Find your code">
    ...
    {/* TODO: Screenshot — the Settings panel showing the referral code with Copy and Regenerate buttons */}
  </Step>
  <Step title="Share it">
...
- They get started faster with a direct connection to you
- You help someone you work with save real time every day
