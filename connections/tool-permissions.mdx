...
Every connected app is a bundle of tools. Gmail has "search inbox" and "send email." Those are different powers, and you set each one on the connected account Runner will use.
