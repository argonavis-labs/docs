...
Runner finds the contact in your CRM and checks both calendars. It then sends the invite with a Zoom link and moves the deal to Demo Scheduled.

> *"Book a demo with the VP of Sales at Nexus this week."*

Once those actions run, the demo is on the calendar and the deal stage is updated. You didn't touch a scheduling link.

### Know who to call today

Runner scans your pipeline for urgency signals, checks who opened your emails in the last 24 hours, drafts follow-ups with CRM context, and blocks time on your calendar for the calls.

> *"Who should I be calling today?"*

Three calls that actually move your number. Drafts written. Runner puts the call blocks on your calendar.
...
| **10:30 AM** | Post-call: drafts the CRM log, follow-up email, and next steps, then writes them to the right apps |
| **12:00 PM** | Pipeline review: flags stalled deals, drafts nudge emails for the stuck ones |
| **1:30 PM** | Books a demo, updates the deal stage, and sends the invite |
