...
Drop your invoices into a session, or point Runner at a Drive folder. It reads each one, matches line items against signed agreements, and flags anomalies. Clean invoices go to an approval queue. Flagged ones come with a summary of what's off.
