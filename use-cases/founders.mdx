...
Not one task at a time. Runner drafts follow-ups while pulling analytics and updates your CRM at the same time. Everything in parallel, with receipts and timestamps for each step. You see the work happening, not just the result.

### It runs in the cloud, 24/7

Runner lives at [app.runner.now](https://app.runner.now) and works in any browser, on any device. Your Runners keep going even when your laptop is closed.

### It uses the context you save

Put durable preferences in [Personal Memory](/using-runner/memory): how you like emails drafted, who your VIPs are, what your board meeting cadence looks like. Future sessions can use those saved facts. The transcript itself doesn't carry forward.

### It runs on a schedule

Set up a Runner once and it repeats. Morning briefing at 7:30am, every weekday, before your first meeting. Follow-up tracker at 5pm. Weekly recap on Friday. No repeat prompt required.
...
| **10:30 AM** | Inbox triage: classifies 40 emails, drafts replies for the 8 that matter, and archives the rest |
| **11:00 AM** | Drafts a reply to your investor's email with the latest ARR numbers from your docs |
| **1:00 PM** | Post-meeting: turns your notes into action items and sends a follow-up to attendees |
